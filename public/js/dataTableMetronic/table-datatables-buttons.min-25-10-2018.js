var TableDatatablesButtons = function () {
    ...
    var initTable1_exp = function () {
        var table = $('#sample_1_exp');
    ...
    var initTable2_exp = function () {
        var table = $('#sample_2_exp');
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                ...
                { extend: 'copy', className: 'btn default', text: 'Copiar'},
    ...
    var initTable3_exp = function () {
        var table = $('#sample_3_exp');
        ...
        $('#sample_3_exp_tools > li > a.tool-action').on('click', function() {
    ...
    var initTable4_exp = function () {
        var table = $('#sample_4_exp');
        ...
        var oTable = table.dataTable({
            ...
            "lengthMenu": [
                [40, 80, 150, 300, -1],
                [40, 80, 150, 300, "Todos"] // change per page values here
            ],
            // set the initial value
            "pageLength": 40,
