!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
               ($.fn.modalmanager ? "" : "</div>") +
              "</div>" +
              "<a class='btn default" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-link'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            /*
            19/07/2017      RETIRANDO O ENVIO DE ANEXO DE IMAGEM 
