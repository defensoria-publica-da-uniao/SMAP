<?php
    ...
    require_once 'controller/relatorios/Crel_pendencias.php';
?>
                                    ...
                                    <div class="page-title" align="center">
                                        <span class="caption-subject font-dark bold uppercase">
                                            ...
                                            <div class="m-heading-1 border-green m-bordered">
                                                <h3 style="margin-top: 10px;"><b>Relatório de Pendências</b></h3>
                                            </div>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-xs-12 col-sm-12">
                                    <div class="portlet light ">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <form  class="rounded" method="POST" action="<?php echo RAIZ . 'relatorios/rel_pendencias' ?>" enctype="multipart/form-data" onSubmit="return valida()">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <span style="text-align: left !important;" class="help-block"> Por período de Vencimento </span>
                                                            <select name="periodo" class="form-control" required >
                                                                <option value=""></option>
                                                                <!--
                                                                <option value="2">Parados (+ 2 dias)</option>
                                                                <option value="5">Parados (+ 5 dias)</option>
                                                                -->
                                                                <option value="15">Parados (+ 15 dias)</option>
                                                                <option value="30">Parados (+ 30 dias)</option> 
                                                                <option value="60">Parados (+ 60 dias)</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-3">
                                            ...
                                            <div class="portlet-title">
                                                <div class="caption font-dark">
                                                    <span class="caption-subject ">
                                                        ...
                                                        Por unidade <span class="font-blue-sharp"><?php echo $destino_sel ?></span> 
                                                        sem movimentação dês do dia <span class="font-blue-sharp"><?php echo date('d/m/Y', strtotime($periodo)); ?></span> 
                                                    </span>
                                                </div>
                                                <div class="tools"> </div>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center" ><?php echo $vencimento[$x] ?></td>
                                                            </tr>
                                                        <?php
                                                            }
                                                        ?>
                                    ...
                                    <div class="col-lg-12 col-xs-12 col-sm-12">
                                        <div class="portlet light ">
                                            ...
                                            <div class="portlet-body form">
                                                <form role="form" action="<?php echo RAIZ . 'home/pdf'; ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input name="tipo" type="hidden" value="pendencias">
...
<script>
    ...
    $(document).ready(function () {
        $('#opcao2').change(function () {
            $('#unidades_destinos').load(caminho5 + '?destino=' + $('#opcao2').val());
        });
    });
</script>
