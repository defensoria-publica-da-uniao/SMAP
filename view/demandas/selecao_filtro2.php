...
require_once 'controller/demandas/Cselecao3.php';
?>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div align="center" class="col-sm-3 col-md-3 col-lg-3">
                                                            ...
                                                            <a href="limpar"> <input type="button" name="Submit"  class="btn btn-success" value="Limpar Filtro"  /> </a>
                                                        </div>
                                                    </div>
                                                       </form>
                                              ...
                                              <div class="row">
                                                ...
                                                <?php if ($alterar == 1) { ?>
                                                    ...
                                                    <div align="center" class="col-xs-3 col-sm-3 col-md-3 col-lg-2">
                                                        ...
                                                        <input type="hidden" name="duplicados_confirmar" id="duplicados_confirmar"   value=""  />
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <form action='<?php echo RAIZ . 'demandas/exibedemanda_filtro' ?>' method='post'>
                                                                    <input type='hidden' name='id_acompanhamento' value='<?php echo $arDados['id_acompanhamento']; ?>' />
